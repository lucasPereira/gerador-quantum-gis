...
public class ImovelSigef {
	...
	// 02 rt,C,4				(categoria responsável técnico da certificação)	(-)
	// 03 art,C,254				(código responsável técnico certificação)		(-)
	// 04 situacao_i,C,25		(situação jurídica imóvel) 						(Imóvel Registrado; Área Titulada não Registrada; Área não Titulada)
	...
	// 11 area_hecta,N,24,15	(área imóvel)									(decimal sem separador)
